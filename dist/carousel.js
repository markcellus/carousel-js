...
Module.prototype = {
    ...
    error: function error(err) {
        ...
        return this._ensurePromise(this.onError(e)).then(function (customErr) {
            return customErr || e;
        });
    },
     ...
     * @private
     */
    _handleElementInitialState: function _handleElementInitialState() {
        var el = this.options.el;
        if (!el) {
            return;
        }
     ...
     * @private
     */
    _resetElementInitialState: function _resetElementInitialState() {
     ...
     * @private
     */
    _ensurePromise: function _ensurePromise(func) {
        if (!func || !func.then) {
...
},{"promise":5,"underscore":13}],5:[function(require,module,exports){
'use strict';
...
var CarouselArrows = function (_Module) {
    _inherits(CarouselArrows, _Module);
    ...
    function CarouselArrows(options) {
        ...
        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(CarouselArrows).call(this, options));
        ...
        if (options.leftArrow) {
            _this.arrows.push(options.leftArrow);
            _this._leftArrowEventListener = function (e) {
                return _this.onLeftArrowClick(e);
            };
            options.leftArrow.addEventListener('click', _this._leftArrowEventListener);
        }

        if (options.rightArrow) {
            _this.arrows.push(options.rightArrow);
            _this._rightArrowEventListener = function (e) {
                return _this.onRightArrowClick(e);
            };
            options.rightArrow.addEventListener('click', _this._rightArrowEventListener);
        }
        return _this;
    }
    ...
    _createClass(CarouselArrows, [{
        ...
        value: function destroy() {
            ...
            _get(Object.getPrototypeOf(CarouselArrows.prototype), 'destroy', this).call(this);
        }
    }]);
...
},{"lodash":3,"module-js":4}],15:[function(require,module,exports){
'use strict';
...
var CarouselPanels = function (_Module) {
    _inherits(CarouselPanels, _Module);
    ...
    function CarouselPanels(options) {
        ...
        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(CarouselPanels).call(this, options));
    ...
    _createClass(CarouselPanels, [{
        ...
        key: '_updatePanels',
        value: function _updatePanels(index) {
        ...
        key: 'loadPanelImageAsset',
        value: function loadPanelImageAsset(img) {
        ...
        value: function destroy() {
            ...
            _get(Object.getPrototypeOf(CarouselPanels.prototype), 'destroy', this).call(this);
        }
    }]);
...
},{"lodash":3,"module-js":4,"promise":5}],16:[function(require,module,exports){
'use strict';
...
var CarouselThumbs = function (_Module) {
    _inherits(CarouselThumbs, _Module);
    ...
    function CarouselThumbs(options) {
        ...
        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(CarouselThumbs).call(this, options));

        _this.options = options;
        _this._thumbnailEventListener = _this.onThumbnailEvent.bind(_this);
        _this.setup();
    ...
    _createClass(CarouselThumbs, [{
        ...
        value: function destroy() {
            ...
            _get(Object.getPrototypeOf(CarouselThumbs.prototype), 'destroy', this).call(this);
        }
    }]);
...
},{"lodash":3,"module-js":4}],17:[function(require,module,exports){
'use strict';
...
var Carousel = function (_Module) {
    ...
    function Carousel(options) {
        ...
        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(Carousel).call(this, options));

        _this.options = options;
        _this._checkForInitErrors();
        _this.setup();
        return _this;
    }
    ...
    _createClass(Carousel, [{
        ...
        key: 'setupThumbs',
        value: function setupThumbs(options) {
            return new _carouselThumbs2.default(_lodash2.default.extend({}, options, {
        ...
        key: 'setupPanels',
        value: function setupPanels(options) {
            if (options.panels.length) {
                return new _carouselPanels2.default(_lodash2.default.extend({}, options, {
        ...
        key: 'setupArrows',
        value: function setupArrows(options) {
            var internalOptions;
            // make clone of original options
            internalOptions = _lodash2.default.extend({}, options);
...
},{"./carousel-arrows":14,"./carousel-panels":15,"./carousel-thumbs":16,"lodash":3,"module-js":4}]},{},[17])(17)
});